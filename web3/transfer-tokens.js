...
const { getContractByTokenAddress } = require('./utils')
...
const transferV2 = async function ({
    ...
    if (tokenAddress !== null) {
        tokenSmartContract = await getContractByTokenAddress(web3, tokenAddress)
    }
    ...
    web3.eth.accounts.wallet.decrypt([keyStore], walletPassword)
