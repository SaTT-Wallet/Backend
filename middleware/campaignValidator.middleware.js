...
const validateAddressNoRequried = (pattern) => Joi.string().pattern(new RegExp(pattern));
...
const schemas = {
    ...
    campaignPrompSchema: Joi.object({
        influencer: validateAddressNoRequried("^0x[a-fA-F0-9]{40}$|^(bc1|[13])[a-zA-HJ-NP-Z0-9]{25,39}$|T[A-Za-z1-9]{33}$"),
    }),
...
module.exports = {
    ...
    campaignPrompValidation: validationCustomMiddleware(schemas.campaignPrompSchema, 'query', schemas.idCheckSchema, 'params'),
    expandUrlValidation: validationMiddleware(schemas.expandUrlSchema, 'query'),
    linkNotificationsValidation: validationMiddleware(schemas.linkNotificationsSchema, 'body'),
    ...
    statLinkCampaignValidation: validationMiddleware(schemas.statLinkCampaignSchema, 'params'),
    rejectLinkValidation: validationCustomMiddleware(schemas.idCheckSchema, 'params', schemas.rejectLinkSchema, 'body'),
    coverByCampaignValidation: validationCustomMiddleware(schemas.idCheckSchema, 'params', schemas.coverByCampaignSchema, 'query'),
    getLinksValidation: validationCustomMiddleware(schemas.userIdCheckSchema, 'params', schemas.getLinksSchema, 'query'),
    validateCampaignValidation: validationMiddleware(schemas.validateCampaignSchema, 'body'),
