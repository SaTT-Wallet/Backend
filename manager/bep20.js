module.exports = async function (app) {
    ...
    bep20Manager.contract = new web3.eth.Contract(
        app.config.ctrs.bep20.abi,
        app.config.ctrs.bep20.address.mainnet
    )

    if (app.web3Bep20Websocket) {
        bep20Manager.contractWS = new app.web3Bep20Websocket.eth.Contract(
            app.config.ctrs.bep20.abi,
            app.config.ctrs.bep20.address.mainnet
        )
    }
    ...
    bep20Manager.mint = async (amount) => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                var receipt = await bep20Manager.contract.methods
                    .mint(amount)
                    .send({
    ...
    bep20Manager.transferNativeBNB = async (to, amount, credentials) => {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                var receipt = await app.web3Bep20.eth
                    .sendTransaction({
