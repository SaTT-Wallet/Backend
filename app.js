...
app.use(cors('*'));
  app.use((req, res, next) => {
    ...
    if(req.headers.origin) {
        if(req.headers.origin === "https://dapp.satt.com" || req.headers.origin === "https://satt-token.com" || req.headers.origin === "https://app.ihave.io" || req.headers.origin === "http://backoffice.atayen.us") return next();
    } else {
