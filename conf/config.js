...
module.exports = async function (app) {
    return new Promise((resolve, reject) => {
        ...
        config.ethBridge =
            'wss://ropsten.infura.io/ws/v3/0fab761c6a7f4934a892dddebf80f8e0'
        config.bscBridge =
            'wss://apis.ankr.com/wss/8b547da7926f4c3ea2520e67343cb13a/b7c61a14f570c697e65cb693a683cda4/binance/full/test'

        config.tokenMainnet = process.env.CONST_TOKEN_ADDRESS_MAINNET
        config.tokenTestnet = process.env.CONST_TOKEN_ADDRESS_TESTNET
        config.tokenTetherMainnet =
            process.env.CONST_TOKEN_ADDRESS_TETHERMAINNET
        config.tokentethertestnet =
            process.env.CONST_TOKEN_ADDRESS_TETHERTESTNET
        ...
        config.compaignMainnetBep20 =
            process.env.CONST_COMPAIGN_ADDRESS_MAINNETBEP20
        config.compaignTestNetBep20 =
        ...
        config.oracleMainnetBep20 =
            process.env.CONST_ORACLE_ADDRESS_MAINNETBEP20
        config.oracleTestnetBep20 =
        ...
        config.cronBalanceUsersStatsDaily =
            process.env.CRON_WALLET_USERS_sTAT_DAILY
        config.cronBalanceUsersStatsMonthly =
            process.env.CRON_WALLET_USERS_sTAT_MONTHLY
        config.cronBalanceUsersStatsWeekly =
            process.env.CRON_WALLET_USERS_sTAT_WEEKLY
        ...
        config.APIURLBEP20 = process.env.API_URL_BEP20
