...
module.exports = async function (app) {
  return new Promise((resolve, reject) => {
    ...
    (config.sandBoxKey = process.env.SEND_BOX), (config.uiad = process.env.UIAD);
    ...
    config.mongoURI =
      'mongodb://' + config.mongoHost + ':' + config.mongoPort + '/' + config.mongoBase;
    ...
    config.sattBep20 = {
      ...
      crypto: {
        ciphertext: '2dba72cd6b838d3a2f28b8f3f41a456be5242de1970aeda4fa61a68a042e6352',
        cipherparams: {
